...
function Services() {
  ...
  return (
    <div  className='flex flex-col-reverse gap-5 space-x-2 xl:gap-0 xl:flex-row items-center justify-between xl:justify-between px-5 py-3 lg:px-10 mt-10 xl:px-20 xl:py-5'>
      ...
      <div ref={ref1} className={`flex flex-wrap xl:flex-row items-center justify-center gap-6 w-full xl:w-1/2 transition-all ease-in-out duration-1000 ${isVisible1 ? "xl:-translate-y-0 opacity-100" : "xl:-translate-y-10 opacity-0"}`}>
