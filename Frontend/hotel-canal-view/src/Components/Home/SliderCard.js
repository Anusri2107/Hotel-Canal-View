        ...
        <div className="relative h-full lg:w-1/3 xl:w-1/4 bg-[color:var(--color1)] transition-all duration-1000 opacity-0 -translate-x-full group-hover:opacity-100 group-hover:translate-x-0">
          <div className="flex flex-col py-2 lg:py-10 px-5 h-full justify-end lg:gap-4">
            ...
            <div className="flex flex-col justify-end gap-2">
              ...
              <Link to="/rooms">
                <button className="flex text-[color:var(--color2)] items-center justify-center gap-2 bg-[color:var(--color4)] md:w-1/2 px-1 py-2 md:p-2 xl:py-5 focus:ring-2 focus:ring-[color:var(--color4)] focus:bg-[color:var(--color2)] focus:text-[color:var(--color4)] group/button">
                  READ MORE
